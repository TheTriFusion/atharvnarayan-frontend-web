...
const API_BASE_URL = import.meta.env.VITE_API_URL || 'http://43.204.211.69:5000/api';
  ...
  const requestPromise = (async () => {
    try {
      ...
      if (error.name === 'TypeError' && error.message.includes('fetch')) {
        ...
        throw new Error('Cannot connect to server. Please ensure the backend is running on http://43.204.211.69:5000');
      }
