...
const DriverManagement = () => {
    ...
    const fetchDrivers = async () => {
        try {
            ...
            const response = await axios.get('https://api.thetrifusion.in/api/cattle-feed-truck/drivers', {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingDriver) {
                ...
                await axios.put(
                    `https://api.thetrifusion.in/api/cattle-feed-truck/drivers/${editingDriver._id}`,
                    updateData,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            } else {
                ...
                await axios.post('https://api.thetrifusion.in/api/cattle-feed-truck/drivers', data, {
                    headers: { Authorization: `Bearer ${token}` },
                });
            }
            setShowModal(false);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`https://api.thetrifusion.in/api/cattle-feed-truck/drivers/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
            fetchDrivers();
        } catch (error) {
