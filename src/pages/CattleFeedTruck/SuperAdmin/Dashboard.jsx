...
const CattleFeedTruckSuperAdminDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            // Fetch all owners
            const ownersResponse = await axios.get('http://15.206.212.140:5000/api/users?role=cattleFeedTruckOwner&systemType=cattleFeedTruck', { headers });
            ...
            if (selectedOwnerId) {
                const [warehouses, vehicles, deliveryPoints, routes, drivers, trips] = await Promise.all([
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/warehouses', { headers }),
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/vehicles', { headers }),
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/delivery-points', { headers }),
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/routes', { headers }),
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/drivers', { headers }),
                    axios.get('http://15.206.212.140:5000/api/cattle-feed-truck/trips', { headers }),
                ]);
