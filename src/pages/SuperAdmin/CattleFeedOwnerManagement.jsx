...
const CattleFeedOwnerManagement = () => {
  ...
  const validateForm = () => {
    // Simplified validation for brevity, keep robust in practice
    const newErrors = {};
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this cattle feed owner?')) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-800">Cattle Feed Owners</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredOwners.length === 0 ? (
                <tr><td colSpan="6" className="text-center py-4">No owners found</td></tr>
              ) : (
                filteredOwners.map(owner => (
                  <tr key={owner._id || owner.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-gray-500">{owner.phoneNumber || owner.phone}</td>
                    ...
                    <td className="px-4 py-3 flex gap-2">
                      ...
                      <Button variant="secondary" className="text-xs px-2 py-1" onClick={() => handleEdit(owner)}>Edit</Button>
                      <Button variant="danger" className="text-xs px-2 py-1" onClick={() => handleDelete(owner._id || owner.id)}>Delete</Button>
                    </td>
                  </tr>
                ))
              )}
