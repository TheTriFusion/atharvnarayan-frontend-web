...
} from '../../utils/cattleFeedTruckStorage';
...
const CattleFeedTruckOwnerManagement = () => {
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this cattle feed truck owner?')) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-bold text-gray-800">Cattle Feed Truck Owners</h2>
            ...
            <Card>
                <Input label="Search" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Search by name, phone, or company..." />
            </Card>
            ...
            <Modal isOpen={showForm} onClose={resetForm} title={editingOwner ? 'Edit Owner' : 'Add Owner'}>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Input label="Company Name" name="companyName" value={formData.companyName} onChange={handleInputChange} placeholder="e.g., XYZ Cattle Feed Transport" />
